...
-   Is the report clear (whole sentences, typos, grammar)? Do readers have a clear idea what's going on and how results are produced by just reading the report? Take some points off if the solutions are too succinct to grasp, or there are too many typos/grammar.
	- Some outputs that were way too too long. Do not include these outputs in the future. (-2) 
...
- Q1 (38/50)
    ...
    - Q1.1 (23/25) 
    	- It is unclear which point characters correspond to which procedure types (-2)
    
    - Q1.2 (15/25)
    	- Not enough points, graphs are not correct. There should be a stayid facet, need to plot for two stayids (-10)
...
- Q7 (28/30) Check the final number of rows and the first few rows of the final data frame.
	- Need to filter age at intime >=18 (-2)
