...
```{r}
#chartevents <- read_csv_arrow("~/mimic/icu/chartevents.csv.gz")
#write_dataset(chartevents, "chartevents.parquet", format = "parquet")
...
library(arrow)
icustays_tble <- read_csv("~/mimic/icu/icustays.csv.gz")
icustays_arrow <- as_arrow_table(icustays_tble)
# Transform the data type
icustays_arrow <- icustays_arrow %>%
  mutate(subject_id = cast(subject_id, int64()))
schema(icustays_arrow)
# Load labevents
