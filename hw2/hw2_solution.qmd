...
dataset_arrow <- arrow::open_dataset(
  sources = "/Users/guojiayi/Documents/study/2025winter/203b/biostat-203b-2025-winter/hw2/labevents.csv", 
  schema = NULL, 
  format = "csv"
)
...
filter_arrow_2 <- dataset_arrow_2 %>%
  select(subject_id, itemid, charttime, valuenum) %>%
  filter(
    itemid == 50912 | 
    itemid == 50971 | 
...
arrow::write_dataset(
  filter_arrow_2, 
  "/Users/guojiayi/Documents/study/2025winter/203b/biostat-203b-2025-winter/hw2", 
  format = "parquet"
  )
system.time(dataset_arrow_2 <- arrow::open_dataset(
  sources = "/Users/guojiayi/Documents/study/2025winter/203b/biostat-203b-2025-winter/hw2/labevents.csv", 
  schema = NULL, 
  format = "csv"
)
...
result_parquet <- open_dataset(
  sources = "/Users/guojiayi/Documents/study/2025winter/203b/biostat-203b-2025-winter/hw2/part-0.parquet", 
  format = "parquet"
)
head(result_parquet, 10)
nrow(result_parquet)
