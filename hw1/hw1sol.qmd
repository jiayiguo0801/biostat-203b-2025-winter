...
```{bash}
ls -l ~/Downloads/mimic/hosp/
ls -l ~/Downloads/mimic/icu/
...
```{bash}
#| eval: false
for datafile in ~/downloads/mimic/hosp/{a,l,pa}*.gz
do
  ls -l $datafile
done
```
...
```{bash}
gzcat /Users/guojiayi/Downloads/mimic/hosp/d_hcpcs.csv.gz|wc -l
for datafile in ~/downloads/mimic/hosp/{a,l,pa}*.gz
do
  gzcat $datafile|wc -l
done
...
```{bash}
gzcat /Users/guojiayi/Downloads/mimic/hosp/admissions.csv.gz | head
gzcat /Users/guojiayi/Downloads/mimic/hosp/admissions.csv.gz | tail -n +2 | wc -l
gzcat /Users/guojiayi/Downloads/mimic/hosp/admissions.csv.gz | awk -F',' 'NR > 1 {print $2}' | sort | uniq | wc -l
gzcat /Users/guojiayi/Downloads/mimic/hosp/admissions.csv.gz | awk -F',' 'NR > 1 {print $1}' | sort | uniq | wc -l
gzcat /Users/guojiayi/Downloads/mimic/hosp/patients.csv.gz | awk -F',' 'NR > 1 {print $1}' | sort | uniq | wc -l
...
```{bash}
gzcat /Users/guojiayi/Downloads/mimic/hosp/admissions.csv.gz | tail -n +2 | awk -F',' '{print $6}' | sort | uniq -c | sort -nr
gzcat /Users/guojiayi/Downloads/mimic/hosp/admissions.csv.gz | tail -n +2 | awk -F',' '{print $8}' | sort | uniq -c | sort -nr
gzcat /Users/guojiayi/Downloads/mimic/hosp/admissions.csv.gz | tail -n +2 | awk -F',' '{print $10}' | sort | uniq -c | sort -nr
gzcat /Users/guojiayi/Downloads/mimic/hosp/admissions.csv.gz | tail -n +2 | awk -F',' '{print $13}' | sort | uniq -c | sort -nr
...
```{bash}
gzcat /Users/guojiayi/Downloads/mimic/icu/icustays.csv.gz | tail -n +2 | wc -l
gzcat /Users/guojiayi/Downloads/mimic/icu/icustays.csv.gz | tail -n +2 | awk -F',' '{print $2}' | sort | uniq | wc -l
ls /Users/guojiayi/Downloads/mimic/icu/
...
```{bash}
gzip /Users/guojiayi/Downloads/mimic/hosp/labevents.csv.gz
ls -lh ~/Users/guojiayi/Downloads/mimic/hosp/labevents.csv.gz ~/Users/guojiayi/Downloads/mimic/hosp/labevents.csv
time gzcat /Users/guojiayi/Downloads/mimic/hosp/labevents.csv.gz | wc -l

time wc -l ~/Users/guojiayi/Downloads/mimic/hosp/labevents.csv
...
```{bash}
#| eval: false
chmod +x /Users/guojiayi/Desktop/biostat-203b-2025-winter/hw1/middle.sh
...
![section 4.1.5](/Users/guojiayi/Desktop/section4.1.5.png)
