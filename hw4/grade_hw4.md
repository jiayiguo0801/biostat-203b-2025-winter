...
- Q1 (98/100)
	- Q1.8 - Need information on vitals as well (-2)
...
- Q2 (80/100)
	- Graphs for Lab Measurements and vitals produce errors (-5)
	- A dropdown list of subject id's would be more reasonable instead of a text input for the patients (-5)
	- Missing the ICU line graphs from Q1 in hw3 (-10)
